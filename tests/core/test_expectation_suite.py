...
def suite_with_table_and_column_expectations(
    exp1, exp2, exp3, exp4, table_exp1, table_exp2, table_exp3
):
    suite = ExpectationSuite(
        expectation_suite_name="warning",
        expectations=[exp1, exp2, exp3, exp4, table_exp1, table_exp2, table_exp3],
        meta={"notes": "This is an expectation suite."},
    )
    assert suite.expectations == [exp1, exp2, exp3, exp4, table_exp1, table_exp2, table_exp3]
    return suite
